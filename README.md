...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/svgpath2mpl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14086&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/svgpath2mpl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `svgpath2mpl` can be installed with:

```
conda install svgpath2mpl
```

It is possible to list all of the versions of `svgpath2mpl` available on your platform with:
